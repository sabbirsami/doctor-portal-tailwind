            ...
            <div className="container mx-auto">
                <div className="hero lg:min-h-[100vh] text-white">
                    <div className="hero-content mr-auto">
                        ...
                        <div className="lg:pb-44 py-20">
                            <p className=" text-2xl">Creating</p>
                            <h1 className="pb-8 lg:text-8xl text-6xl font-bold">
                                Brighter Smiles
                            </h1>
                            <div className="">
                                <button className="btn lg:inline block btn-outline border-2 bg-emerald-500 text-white mr-4 border-sky-200 px-8 mb-2 rounded-0 shadow-2xl">
                                    Contact{" "}
                                </button>
